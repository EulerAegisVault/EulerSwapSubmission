...
# --- euler Configuration ---
RPC_URL = os.getenv("NEAR_TESTNET_RPC_URL")  # euler testnet RPC
...
print(f"✅ euler Configuration loaded on chain {CHAIN_ID}")
print(f"🌐 euler RPC: {RPC_URL}")
print(f"🎲 VRF Strategy: {VRF_STRATEGY_ADDRESS}")
print(f"💰 Agent has euler ETH for gas fees")